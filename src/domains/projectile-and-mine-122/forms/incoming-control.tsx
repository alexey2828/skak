...
const IncomingControl122: React.FC<RouteProps> = ({route}) => {
  ...
  const submitForm = async () => {
    try {
      ...
      const requestDataToCommon = {
        serverUrl: URLS.SERVER_URL,
        urlParam: URL_PARAMS.DB_ADD_INCOMING_CONTROL_122,
        checkGlassThread: checkGlassThread,
        checkHousingRing3: checkHousingRing3,
        checkHousingRing4: checkHousingRing4,
    ...
    <>
      <View style={[styles.container, {marginTop: -30}]}>
        ...
        <Text style={IndexStyle.TopTitle}>
          {PROJECTILE_AND_MINE_TITLES.INCOMING_CONTROL}
        </Text>
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.checkboxContainer}>
            <TouchableOpacity
              ...
              <View style={{width: 250}}>
                <Text style={IndexStyle.BottomTitle}>
                  {PROJECTILE_AND_MINE_TITLES.CHECK_HOUSING_RING_3}:{' '}
                </Text>
              </View>
            </TouchableOpacity>
            <Switch
          ...
          <View style={styles.checkboxContainer}>
            <TouchableOpacity
              ...
              <View style={{width: 250}}>
                <Text style={IndexStyle.BottomTitle}>
                  {PROJECTILE_AND_MINE_TITLES.CHECK_HOUSING_RING_4}:{' '}
                </Text>
              </View>
            </TouchableOpacity>
            <Switch
...
export default IncomingControl122;
