...
import {ChooseMarkForWeight122} from '../../../infrastucture/choose-data/choose-mark-for-weight-122';

const TotalBodyWeight122: React.FC<RouteProps> = ({route}) => {
  ...
  let weightSign = ChooseMarkForWeight122(curbWeightFixed);
...
export default TotalBodyWeight122;
